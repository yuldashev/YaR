                ...
                <div class="col-lg-12 col-md-12">
					...
					<?php
						...
						if ($auth==0) {
							...
							$f=unserialize(file_get_contents('https://reg.moyput13.ru/module/roman/get_yar_2/'));
							...
							function foreach_array($array,&$i,$url){
								foreach($array as $title=>$value){
									if (is_array($value)) {
										...
										if (strpos($value,'.pdf')) {
											echo '<p style="padding-left:30px; cursor:pointer; color:#2a5885; margin-bottom:2px;" class="get_file"><a href="" data-fancybox data-type="iframe" data-src="https://reg.moyput13.ru/yar_2'.$url.'/'.$value.'"><i><i class="fa fa-file-pdf-o"></i> &nbsp;&nbsp; '.$value.'</i></a></p>';
										} elseif (strpos($value,'.mp4')) {
											echo '<p style="padding-left:30px; cursor:pointer; color:#2a5885; margin-bottom:2px;" class="get_file"><a href="" data-fancybox data-type="iframe" data-src="https://reg.moyput13.ru/yar_2'.$url.'/'.$value.'"><i><i class="fa fa-file-video-o"></i> &nbsp;&nbsp; '.$value.'</i></a></p>';
										} else {
											echo '<p style="padding-left:30px; cursor:pointer; color:#2a5885; margin-bottom:2px;" class="get_file"><a href="" data-fancybox data-type="iframe" data-src="https://reg.moyput13.ru/yar_2'.$url.'/'.$value.'"><i>'.$value.'</i></a></p>';
										}
